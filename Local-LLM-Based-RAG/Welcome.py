...
st.set_page_config(
    page_title="NeuralNinja - Your Conversational Platform", page_icon="🤖"
)
...
def display_sidebar_content() -> None:
    ...
    st.sidebar.markdown(
        "<h2 style='text-align: center;'>NeuralNinja🧠</h2>", unsafe_allow_html=True
    )
    st.sidebar.markdown(
